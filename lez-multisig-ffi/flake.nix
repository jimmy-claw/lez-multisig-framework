{
  description = "lez-multisig-ffi — C FFI shared library for the LEZ Multisig program";
    ...
    in
    {
      packages = forAll (system:
        let
          ...
          # Reusing the same circuits archive from lez-registry
          ...
          src = lib.cleanSourceWith {
            src = ./..;  # workspace root (lez-multisig/)
            filter = path: type:
